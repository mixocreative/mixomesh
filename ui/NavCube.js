...
export function init() {
  ...
  _root.innerHTML = `
    <div class="nc-cube" id="nc-cube">
      <div class="nc-face nc-front"  data-preset="front">FRONT</div>
      <div class="nc-face nc-back"   data-preset="back">BACK</div>
      <div class="nc-face nc-left"   data-preset="left">LEFT</div>
      <div class="nc-face nc-right"  data-preset="right">RIGHT</div>
      <div class="nc-face nc-top"    data-preset="top">TOP</div>
      <div class="nc-face nc-bottom" data-preset="bottom">BOTTOM</div>
    </div>
