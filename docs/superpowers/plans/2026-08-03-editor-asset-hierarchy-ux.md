...
`be2d9d9`; Task 7 shipped in `46ca2fe`; Task 8 shipped in `99571b9`. Task 9 is
implemented and verified in the print-readiness commit following that shader
identity boundary. Task 10 is next.
