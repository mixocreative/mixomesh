...
// Raw values in glTF / STL / OBJ are interpreted as millimetres unless the
// user overrides the source unit per-asset.
...
export function importScaleFactor(sourceUnit, modelRatio) {
  return SOURCE_UNIT_FACTORS[sourceUnit] * ((modelRatio ?? 1) / _currentWorkingRatio());
}
